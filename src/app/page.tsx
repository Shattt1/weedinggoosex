    ...
    if (isSuccess) {
        return (
            <div className="text-center py-8">
                <p className="text-xl text-[#8B7355]">Спасибо! ❤️ Ваш ответ отправлен.</p>
            </div>
        );
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8">
            <div className="text-left">
                <label className="block mb-4 text-lg text-[#8B7355]">Ваше Имя и Фамилия</label>
                <input
                    type="text"
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    placeholder="Иванов Иван"
                    className="w-full bg-white border border-[#8B7355] px-6 py-4 text-[#8B7355] placeholder-[#A08C6C] focus:outline-none focus:border-[#8B7355] transition-colors rounded"
                    required
                />
            </div>
            <div className="text-left">
                <label className="block mb-6 text-lg text-[#8B7355]">Сможете ли вы присутствовать?</label>
                <div className="space-y-4">
                    <label className="flex items-center gap-4 cursor-pointer text-[#8B7355]">
                        <input
                            type="radio"
                            name="attending"
                            value="yes"
            ...
            <button
                ...
                className="bg-[#8B7355] text-white px-12 py-4 text-sm tracking-wider hover:bg-[#6B5A45] transition-colors disabled:opacity-50 rounded"
            >
...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-[#FAF0E6] text-[#8B7355]">
            {/* Hero Section */}
            ...
            <section className="py-20 px-6 max-w-4xl mx-auto text-center animate-on-scroll">
                <h2 className="text-5xl md:text-6xl font-script italic mb-12 text-[#8B7355]">Дорогие гости!</h2>
                ...
                {/* Calendar */}
                <h3 className="text-4xl md:text-5xl font-serif tracking-widest mb-8 text-[#8B7355]">ФЕВРАЛЬ 2026</h3>
                <div className="flex justify-center gap-4 md:gap-8 mb-4 text-sm md:text-base text-[#A08C6C]">
                ...
                <div className="flex justify-center gap-4 md:gap-8 text-lg md:text-xl text-[#8B7355]">
                    ...
                    <span className="w-8 md:w-12 h-8 md:h-12 flex items-center justify-center relative animate-fade-in" style={{ animationDelay: '2.4s' }}>
                        ...
                        <svg className="absolute inset-0 m-auto w-10 h-10 md:w-14 md:h-14 animate-heartbeat" viewBox="0 0 24 24" fill="none" stroke="#8B7355" strokeWidth="1.5">
                ...
                {/* Countdown Timer */}
                <div className="mt-16 pt-12 border-t border-[#A08C6C]">
                    <div className="grid grid-cols-4 gap-4 md:gap-8 max-w-2xl mx-auto">
                        <div className="text-center">
                            <div className="text-4xl md:text-6xl font-serif text-[#8B7355] mb-2">{timeLeft.days}</div>
                            <div className="text-xs md:text-sm uppercase tracking-wider text-[#A08C6C]">дней</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl md:text-6xl font-serif text-[#8B7355] mb-2">{timeLeft.hours}</div>
                            <div className="text-xs md:text-sm uppercase tracking-wider text-[#A08C6C]">часов</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl md:text-6xl font-serif text-[#8B7355] mb-2">{timeLeft.minutes}</div>
                            <div className="text-xs md:text-sm uppercase tracking-wider text-[#A08C6C]">минут</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl md:text-6xl font-serif text-[#8B7355] mb-2">{timeLeft.seconds}</div>
                            <div className="text-xs md:text-sm uppercase tracking-wider text-[#A08C6C]">секунд</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 px-6 max-w-5xl mx-auto">
                <h2 className="text-5xl md:text-6xl font-script italic text-center mb-16 text-[#8B7355] animate-on-scroll">Программа вечера</h2>
                <div className="grid md:grid-cols-3 gap-8 md:gap-12">
                    <div className="text-center animate-on-scroll" style={{ animationDelay: '0.1s' }}>
                        ...
                        <div className="text-4xl md:text-5xl font-serif mb-2 text-[#8B7355]">13:00</div>
                    ...
                    <div className="text-center animate-on-scroll" style={{ animationDelay: '0.2s' }}>
                        ...
                        <div className="text-4xl md:text-5xl font-serif mb-2 text-[#8B7355]">16:40</div>
                    ...
                    <div className="text-center animate-on-scroll" style={{ animationDelay: '0.3s' }}>
                        ...
                        <div className="text-4xl md:text-5xl font-serif mb-2 text-[#8B7355]">17:10</div>
            ...
            <section className="py-16 px-6 max-w-4xl mx-auto text-center animate-on-scroll">
                <h2 className="text-5xl md:text-6xl font-script italic mb-8 text-[#8B7355]">Место венчания</h2>
                <p className="text-xl md:text-2xl mb-2">Ростовский кафедральный собор Рождества Пресвятой Богородицы"</p>
                <p className="text-lg text-[#A08C6C] mb-8">Ростов-на-Дону, улица Станиславского 58</p>
                <button
                    onClick={() => window.open('https://yandex.ru/maps/?text=Ростов-на-Дону, улица Станиславского 58', '_blank')}
                    className="bg-[#A08C6C] text-white px-8 py-4 text-sm tracking-wider hover:bg-[#8B7355] transition-colors mb-8"
                >
                    ПОСТРОИТЬ МАРШРУТ
                </button>
                <img
            ...
            <section className="py-16 px-6 max-w-4xl mx-auto text-center animate-on-scroll">
                <h2 className="text-5xl md:text-6xl font-script italic mb-8 text-[#8B7355]">Место Банкета</h2>
                <p className="text-xl md:text-2xl mb-2">Банкетный зал "Шарден"</p>
                <p className="text-lg text-[#A08C6C] mb-8">Ростов-на-Дону, улица Белорусская 215/1</p>
                <button
            ...
            <section className="py-16 px-6 max-w-6xl mx-auto text-center">
                <h2 className="text-5xl md:text-6xl font-script italic mb-8">Дресс-код</h2>
                <p className="text-lg md:text-xl leading-relaxed mb-12">
            ...
            <section className="py-16 px-6 max-w-6xl mx-auto">
                <h2 className="text-5xl md:text-6xl font-script italic text-center mb-16 text-[#8B7355] animate-on-scroll">Пожелания</h2>
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-[#A08C6C] text-white p-8 rounded-lg relative animate-on-scroll" style={{ animationDelay: '0.1s' }}>
                    ...
                    <div className="bg-[#A08C6C] text-white p-8 rounded-lg relative animate-on-scroll" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="bg-[#A08C6C] text-white p-8 rounded-lg relative animate-on-scroll" style={{ animationDelay: '0.3s' }}>
            ...
            {/* Organizer Contact */}
            <section className="py-16 px-6 max-w-4xl mx-auto text-center animate-on-scroll">
                <h2 className="text-5xl md:text-6xl font-script italic mb-8 text-[#8B7355]">Наш организатор</h2>
                ...
                <h3 className="text-5xl font-serif tracking-[0.3em] mb-8 text-[#8B7355]">1</h3>
                <button className="bg-[#A08C6C] text-white px-8 py-4 text-sm tracking-wider hover:bg-[#8B7355] transition-colors mb-8">
                    213
                </button>
                <div className="flex justify-center gap-4">
                    <a href="https://wa.me/79604706930" className="w-12 h-12 bg-[#A08C6C] rounded-full flex items-center justify-center hover:bg-[#8B7355] transition-colors">
                    ...
                    <a href="https://t.me/" className="w-12 h-12 bg-[#A08C6C] rounded-full flex items-center justify-center hover:bg-[#8B7355] transition-colors">
                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z" />
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/" className="w-12 h-12 bg-[#A08C6C] rounded-full flex items-center justify-center hover:bg-[#8B7355] transition-colors">
                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Closing Message */}
            <section className="py-16 px-6 max-w-4xl mx-auto text-center animate-on-scroll">
                <p className="text-xl md:text-2xl italic mb-2 text-[#8B7355]">Наша история — это самая высокая</p>
                <p className="text-3xl md:text-4xl font-script italic mb-8 text-[#A08C6C]">снежная гора.</p>
                <p className="text-lg leading-relaxed mb-8">
                    Даже те, кто не верит в волшебство<br />
                    и мистику, перевернут<br />
                    свое сознание в этот вечер.
                </p>
                <div className="w-24 h-px bg-[#A08C6C] mx-auto mb-8"></div>
                <p className="text-lg leading-relaxed mb-8">
                    Мы будем очень рады если<br />
                    Вы сможете присутствовать<br />
                    на нашем празднике!
                </p>
                <p className="text-4xl md:text-5xl font-script italic text-[#8B7355]">Павел<br />и Дилафруз</p>
            </section>

            {/* RSVP Form */}
            <section className="bg-[#8B7355] py-16 px-6 animate-on-scroll">
