    ...
    return (
        <div className="min-h-screen bg-[#fbfbfb] text-[#413d3d]">
            ...
            <section className="py-16 px-6 max-w-4xl mx-auto text-center animate-on-scroll">
                ...
                <h3 className="text-5xl font-serif tracking-[0.3em] mb-8">1</h3>
                <button className="bg-[#413d3d] text-white px-8 py-4 text-sm tracking-wider hover:bg-[#5a5555] transition-colors mb-8">
                    213
                </button>
                <div className="flex justify-center gap-4">
                    ...
                    <a href="https://t.me/" className="w-12 h-12 bg-[#413d3d] rounded-full flex items-center justify-center hover:bg-[#5a5555] transition-colors">
                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z" />
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/" className="w-12 h-12 bg-[#413d3d] rounded-full flex items-center justify-center hover:bg-[#5a5555] transition-colors">
                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
